...
** The length of the arrays to be searched varies.
...
** If the value is not in the array, the user will be notified that the value is not in the array.
** To exit the program the user will enter -1.
*/
...
int main()
{
    ...
    // TODO: write code to determine if integers entered by the user are in searchArray
    while(1){
